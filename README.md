...
------Продвинутая разработка, прикольные концепты------ рассмотрим это всё на примере компонента AddTodo
тут пользуемся стандартным хуком useState, но можно создавать свои собственные хуки и улучшать приложения
Допустим мы знаем что в тег input передаём два свойства value & onChange и это можно упростить
                создаю хук со строчки use
